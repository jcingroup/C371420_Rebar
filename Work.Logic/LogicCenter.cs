...
namespace ProcCore.Business
{
    ...
    {
        Base, Apply, Apply_Detail, Equipment, Fuel_Apply, Equipment_Category, Apply_User, Apply_MonthAverage
    }
    public enum SNType
    {
...
namespace ProcCore.Business.LogicConect
{
    ...
    public class LogicCenter
    {
        ...
        private const string DatabaseName = "C36A0_JCIYP";
        ...
        public static C36A0_JCIYPEntities getDB0
        {
            get
            {
                return new C36A0_JCIYPEntities(db0_connectionstring);
            }
        }
